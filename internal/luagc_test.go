...
--assert(dosteps(0) > 10) -- TODO: this is reportedly highly fragile assertion, but it would be good to make sure we know why it fails
--assert(dosteps(6) < dosteps(2)) -- TODO: failed, changed to line below; but see comment above
