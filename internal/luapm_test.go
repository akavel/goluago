...
var code_pm = `print('testing pattern matching')
...
assert(f(' \n isto ` + "\xe9" + ` assim', '%S%S*') == 'isto')
assert(f(' \n isto ` + "\xe9" + ` assim', '%S*$') == 'assim')
assert(f(' \n isto ` + "\xe9" + ` assim', '[a-z]*$') == 'assim')
assert(f('um caracter ? extra', '[^%sa-z]') == '?')
assert(f('', 'a?') == '')
assert(f('` + "\xe1" + `', '` + "\xe1" + `?') == '` + "\xe1" + `')
assert(f('` + "\xe1" + `bl', '` + "\xe1" + `?b?l?') == '` + "\xe1" + `bl')
assert(f('  ` + "\xe1" + `bl', '` + "\xe1" + `?b?l?') == '')
...
assert(string.find("(` + "\xe1" + `lo)", "%(` + "\xe1" + `") == 1)
local a, b, c, d, e = string.match("` + "\xe2" + `lo alo", "^(((.).).* (%w*))$")
assert(a == '` + "\xe2" + `lo alo' and b == '` + "\xe2" + `l' and c == '` + "\xe2" + `' and d == 'alo' and e == nil)
a, b, c, d  = string.match('0123456789', '(.+(.?)())')
assert(a == '0123456789' and b == '' and c == 11 and d == nil)
print('+')

assert(string.gsub('` + "\xfc" + `lo ` + "\xfc" + `lo', '` + "\xfc" + `', 'x') == 'xlo xlo')
assert(string.gsub('alo ` + "\xfa" + `lo  ', ' +$', '') == 'alo ` + "\xfa" + `lo')  -- trim
assert(string.gsub('  alo alo  ', '^%s*(.-)%s*$', '%1') == 'alo alo')  -- double trim
assert(string.gsub('alo  alo  \n 123\n ', '%s+', ' ') == 'alo alo 123 ')
t = "ab` + "\xe7" + ` d"
a, b = string.gsub(t, '(.)', '%1@')
assert('@'..a == string.gsub(t, '', '@') and b == 5)
a, b = string.gsub('ab` + "\xe7" + `d', '(.)', '%0@', 2)
assert(a == 'a@b@` + "\xe7" + `d' and b == 2)
assert(string.gsub('alo alo', '()[al]', '%1') == '12o 56o')
assert(string.gsub("abc=xyz", "(%w*)(%p)(%w+)", "%3%2%1-%0") ==
              "xyz=abc-abc=xyz")
assert(string.gsub("abc", "%w", "%1%0") == "aabbcc")
assert(string.gsub("abc", "%w+", "%0%1") == "abcabc")
assert(string.gsub('` + "\xe1" + `` + "\xe9" + `` + "\xed" + `', '$', '\0` + "\xf3" + `` + "\xfa" + `') == '` + "\xe1" + `` + "\xe9" + `` + "\xed" + `\0` + "\xf3" + `` + "\xfa" + `')
...
assert(string.gsub("trocar tudo em |teste|b| ` + "\xe9" + ` |beleza|al|", "|([^|]*)|([^|]*)|", f) ==
            "trocar tudo em bbbbb ` + "\xe9" + ` alalalalalal")
